...
add wave -noupdate /datapath_tb/DUT/ram_connection/ram_out
add wave -noupdate /datapath_tb/DUT/ram_connection/ram_in
add wave -noupdate /datapath_tb/DUT/ram_connection/addr
add wave -noupdate /datapath_tb/DUT/ram_connection/en
add wave -noupdate /datapath_tb/DUT/ram_connection/clk
add wave -noupdate /datapath_tb/DUT/ram_connection/ram_contents
add wave -noupdate /datapath_tb/DUT/ram_connection/addr_reg
add wave -noupdate /datapath_tb/DUT/ir/q
...
add wave -noupdate /datapath_tb/DUT/mdrMUX/out
add wave -noupdate /datapath_tb/DUT/mdrMUX/enable
add wave -noupdate /datapath_tb/DUT/mdrMUX/a
add wave -noupdate /datapath_tb/DUT/mdrMUX/b
add wave -noupdate /datapath_tb/DUT/mdr/q
add wave -noupdate /datapath_tb/DUT/mdr/d
add wave -noupdate /datapath_tb/DUT/mdr/en
add wave -noupdate /datapath_tb/DUT/mdr/clr
add wave -noupdate /datapath_tb/DUT/mdr/clk
add wave -noupdate /datapath_tb/DUT/mar/q
add wave -noupdate /datapath_tb/DUT/mar/d
add wave -noupdate /datapath_tb/DUT/mar/en
add wave -noupdate /datapath_tb/DUT/mar/clr
add wave -noupdate /datapath_tb/DUT/mar/clk
add wave -noupdate /datapath_tb/DUT/mar/mar_data
...
add wave -noupdate /datapath_tb/op_code
...
WaveRestoreCursors {{Cursor 1} {274445 ps} 0}
