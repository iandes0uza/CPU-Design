...
add wave -noupdate -radix decimal /datapath_tb/DUT/pc/pc_out
...
add wave -noupdate -radix decimal /datapath_tb/DUT/r2/q
...
add wave -noupdate /datapath_tb/DUT/ir/d
add wave -noupdate /datapath_tb/DUT/ir/en
add wave -noupdate /datapath_tb/DUT/ir/clr
add wave -noupdate /datapath_tb/DUT/ir/clk
...
WaveRestoreCursors {{Cursor 1} {66985 ps} 0}
...
update
WaveRestoreZoom {0 ps} {500954 ps}
