...
add wave -noupdate /datapath_tb/DUT/r3/q
add wave -noupdate /datapath_tb/DUT/r3/d
add wave -noupdate /datapath_tb/DUT/r3/en
add wave -noupdate /datapath_tb/DUT/r3/clr
add wave -noupdate /datapath_tb/DUT/r3/clk
...
WaveRestoreCursors {{Cursor 1} {138679 ps} 0}
...
update
WaveRestoreZoom {0 ps} {927053 ps}
